...
const CardPlaceAds = () => (
  <div className="announcesCards">
    ...
    <Container maxWidth="lg">
      <h2 className="announcesCards__title">Si place</h2>
      <Button
      id="create_ad_btn"
      variant="contained"
      size="large"
          ...
          <Card id="card">
            <div id="card__image">
              ...
              <div id="card__bandName">
                <h2 className="bandName">Nom de la salle</h2>
              </div>
            </div>
        ...
        {/* <Grid item xs={4}>
          <Card id="card">
            <div id="card__image">
              ...
              <div id="card__placeName">
                <h2 className="placeName">Nom de la salle</h2>
              </div>
            </div>
            <CardContent id="card__content">
              <ul className="search">
